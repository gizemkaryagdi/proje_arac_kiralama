              ...
              <?php
               if ( !isset($_SESSION["musteri_id"]) ) {
                ...
                echo"<div class='navbar-nav ml-auto py-0'>";
                    $sorgu2 = mysqli_query($conn,"Select * from musteriler where musteri_id='{$_SESSION['musteri_id']}'");
                    $satir2 = mysqli_fetch_array($sorgu2);
                    echo "<div class='nav-item dropdown'>";
                    echo "<a href='profil.php' class='nav-link dropdown-toggle' data-toggle='dropdown' >".$satir2['musteri_ad']." ".$satir2['musteri_soyad']."</a>";
