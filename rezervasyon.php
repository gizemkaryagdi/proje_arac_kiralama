...
<head>
    ...
    function hesapla() {
        ...
        if (sonuc > 0) {
            ...
            document.getElementById("fiyattest").innerHTML = "<?php Print($sorgu2_getir['arac_kira_ucreti']); ?>"+ "₺";
            <?php $error="Bitiş tarihi başlangıç tarihinden erken olamaz."; ?>;
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form name="rezervasyon" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <?php if (@$error) { ?><div hidden name="hata" id="hata" class="errorWrap"><strong>HATA</strong>:<?php echo (@$error); ?> </div><?php } ?>
                    <div class="mb-5">
                        <div class="row">
...
>>>>>>> fb56720cbcc993ac4d44bb6cb4bf133011e0228d
</html>