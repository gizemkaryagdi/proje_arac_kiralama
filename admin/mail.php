...
$alici_mail = $_SESSION['admin_email'];

$token = md5($alici_mail.rand(10,9999));
$url = "https://localhost/proje_arac_kiralama/admin/sifre_sifirla.php?id=$token";

$token_yazdir=mysqli_query($conn,"update admin set admin_token='{$token}' where admin_email='{$alici_mail}'");
