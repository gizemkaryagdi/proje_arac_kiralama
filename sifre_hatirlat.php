...
<div class="container-fluid py-5">
    <div class="container pt-5 pb-3"> 
      ...
      <?php echo $site_bilgileri['site_adi'];  ?> Müşteri Şifre Hatırlatma
      </h1>
        <div class="row justify-content-center">
            <p class="col-lg-10 text-center">
               <form action='sifre_hatirlat_isle.php' method='post' id='giris_form'>
                <table align='center'>
                    <tr>
                    ...
                    <tr>
                        <td align='left'></td>
                        <td align='right'> <input type="submit" value="Hatırlatma Maili Gönder"></td>
                    </tr>
                </table>
                </form>
            </p>
